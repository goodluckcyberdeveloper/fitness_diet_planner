...
<body>
    <nav>
        ...
        <a href="#" onclick="showContent('help')">Help</a>
        <a href="#" onclick="showContent('about')">About</a>
    </nav>
    <div class="hero">
        <h1>Fitness and Diet Planner System</h1>
        <p class="subtitle">Plan your meals and workouts for a healthier lifestyle!</p>
    ...
    <div class="container">
        ...
        <div id="help" class="content">
            <h2>Help</h2>
            <p>Instructions for the Fitness and Diet Planner System:</p>
            <ul>
                <li>Register to start using our system.</li>
                <li>Plan your daily meals based on your health goals.</li>
                <li>Use analysis tools to track your progress.</li>
                <li>Contact us through the "About" section for further assistance.</li>
            </ul>
        </div>
