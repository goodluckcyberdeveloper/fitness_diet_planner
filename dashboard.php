        ...
        <div class="main">
            <div class="info-summary">
                ...
                <table>
                    ...
                    <tr>
                        <td>Diseases</td>
                        <td><?php echo htmlspecialchars($diseases); ?></td>
                    </tr>
                    <tr>
                        <td>Diet Plan</td>
                        <td><?php echo htmlspecialchars(mb_strimwidth($diet_plan, 0, 60, "...")); ?> <a href="meal_plan.php">[Read more]</a></td>
                    </tr>
                    <tr>
                        <td>Exercise Plan</td>
                        <td><?php echo htmlspecialchars(mb_strimwidth($exercise_plan, 0, 60, "...")); ?> <a href="exercise_plan.php">[Read more]</a></td>
                    </tr>
                    <tr>
                        <td>Age</td>
                        <td><?php echo htmlspecialchars($_SESSION["age"] ?? "N/A"); ?> years</td>
                    </tr>
                    <tr>
                        <td>Weight</td>
                        <td><?php echo htmlspecialchars($_SESSION["weight"] ?? "N/A"); ?> kg</td>
                    </tr>
                    <tr>
                        <td>Height</td>
                        <td><?php echo htmlspecialchars($_SESSION["height"] ?? "N/A"); ?> cm</td>
                    </tr>
                    <tr>
                        <td>Blood Pressure</td>
                        <td><?php echo htmlspecialchars($_SESSION["blood_pressure"] ?? "N/A"); ?></td>
                    </tr>
                    <tr>
                        <td>BMI</td>
                        <td><?php echo htmlspecialchars($_SESSION["bmi"] ?? "N/A"); ?></td>
                    </tr>
                </table>
            </div>
        </div>
